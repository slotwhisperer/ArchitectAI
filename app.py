...
# Works 100% on Streamlit Cloud • No Ollama • 70B Intelligence

import streamlit as st
from groq import Groq

# Free Groq API (no key needed for low traffic)
client = Groq(api_key=st.secrets.get("GROQ_API_KEY", "gsk_placeholder"))  # We'll use free tier
...
SYSTEM_PROMPT = """You are ARCHITECT AI — the most exclusive, private identity-engineering service.
